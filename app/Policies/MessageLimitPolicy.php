...
class MessageLimitPolicy
{
    ...
    public function view(AuthUser $authUser, MessageLimit $messageLimit): bool
    {
    ...
    public function update(AuthUser $authUser, MessageLimit $messageLimit): bool
    {
        return $authUser->can('Update:MessageLimit');
    }

    public function delete(AuthUser $authUser, MessageLimit $messageLimit): bool
    {
    ...
    public function restore(AuthUser $authUser, MessageLimit $messageLimit): bool
    {
        return $authUser->can('Restore:MessageLimit');
    }

    public function forceDelete(AuthUser $authUser, MessageLimit $messageLimit): bool
    {
    ...
    public function replicate(AuthUser $authUser, MessageLimit $messageLimit): bool
    {
